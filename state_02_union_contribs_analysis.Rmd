...
Here are the top union donors to Republican candidates...

```{r, echo=FALSE}
topdonors_togopcands <- contribs_tocands %>% 
...
Who are the candidates who have gotten the biggest bails of cash from police unions? Here are the Democrats.
